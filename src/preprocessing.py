...
def generate_student_data(n=200, random_state=42):
    """
    Generates synthetic academic data for students.
    """
...
def save_data(df, path):
    """Saves the dataframe to a given path"""
...
if __name__ == "__main__":
    ...
    save_data(df, "../dataset/raw_data/student_data.csv")
